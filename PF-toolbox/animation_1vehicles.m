...
led.FontSize = 12;
 if (i==100)
    ...
    grid on; %axis equal;
%    axis([-15 15 -15 15 ])
   str ={'Path following method:', controller}; 
  title1 =  title(str);
  title1.FontSize = 12;
    xlabel('Y[m]')
    ylabel('X[m]')
